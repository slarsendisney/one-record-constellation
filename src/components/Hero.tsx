...
export const Hero = (): JSX.Element => {
  ...
  return (
    <>
      <Nav onLogoClick={reset} className="absolute top-0 left-0 z-50" />
      <AnimatePresence>
        {error && (
          <m.div
            initial={{ opacity: 0 }}
          ...
          >
            <div className="max-w-3xl w-full flex items-center bg-black border-white border-2 bg-opacity-40 text-white p-3 space-x-2 rounded">
              ...
              <p>
                We can't seem to make sense of this query, perhaps try one of
            ...
            <div className="space-y-12 flex justify-center items-center flex-col max-w-3xl w-full">
              ...
              <button
                onClick={reset}
                className="bg-blue-600 text-white flex items-center justify-center space-x-2 py-1 px-4 rounded-full text-xl"
              >
        ...
        {!active && !fetching && !error && (
          ...
          >
            ...
            <m.div
              ...
              className="bg-yellow-400 px-2 py-1 rounded-full text-xs flex items-center space-x-1"
            >
              <ServerStackIcon className="w-4 inline-block" />
              <p>london.one-record.lhind.dev</p>
            </m.div>
            <Search />
            <Suggestions />
            <Links />
